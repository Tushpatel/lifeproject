...
+ (NSDictionary *)countryNamesByCode
{
    ...
    if (!_countryNamesByCode)
    {
        ...
        for (NSString *code in [NSLocale ISOCountryCodes])
        {
            ...
            NSArray *excludedCodes = @[@"AQ", @"AS", @"AW", @"AX", @"BL", @"BQ", @"BV", @"CC", @"CK", @"CW", @"CX", @"EH", @"FK", @"FM", @"FO", @"GG", @"GI", @"GP", @"GS", @"GU", @"HK", @"HM", @"IM", @"IO", @"JE", @"KI", @"KY", @"MC", @"MF", @"MH", @"MO", @"MP", @"MQ", @"NC", @"NF", @"NR", @"NU", @"PF", @"PM", @"PN", @"PW", @"RE", @"SH", @"SJ", @"SM", @"ST", @"SX", @"TC", @"TF", @"TK", @"TL", @"TO", @"TV", @"UM", @"VA", @"VG", @"VI", @"WF", @"YT"];
            if([excludedCodes indexOfObject:code] != NSNotFound) {
                continue;
            }
